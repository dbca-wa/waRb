...
Accessing and writing back files from CKAN requires to be in the DBCA intranet 
and to have the following variables defined in your `~/.Renviron`.
The CKAN API key is accessible to logged in users on their profile page.
